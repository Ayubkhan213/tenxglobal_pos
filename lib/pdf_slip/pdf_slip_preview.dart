...
//       // Build IP printer URL
//       final printerUrl = provider.customerPrinter!.url.contains("http")
//           ? provider.customerPrinter!.url
//           : "http://${provider.customerPrinter!.url}:9100";

//       print("🖨 Printer URL: $printerUrl");

//       // Generate lightweight PDF
//       final pdf = await _generateReceiptPDF(orderResponse);
//       final pdfBytes = await pdf.save();
...
//     } catch (e) {
//       _showMessage(context, "❌ Printing failed: $e", Colors.red);
//     }
//   }
