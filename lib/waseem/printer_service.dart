...
//     print(
//         '   Available printers: ${_availablePrinters.map((e) => e.name).join(', ')}');
...
//     print(
//         '🧾 [Customer Receipt] printing to ${_customerPrinter?.name ?? 'NO PRINTER SELECTED'}');
//     print(order);
//   }
...
//     print(
//         '👩‍🍳 [Kitchen KOT] printing to ${_kitchenPrinter?.name ?? 'NO PRINTER SELECTED'}');
//     print(order);
//   }
// }
